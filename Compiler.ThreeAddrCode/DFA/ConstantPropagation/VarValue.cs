...
namespace Compiler.ThreeAddrCode.DFA.ConstantPropagation
{
    public class VarValue
    {
        ...
        public VarValue UseOperation(VarValue right, OpCode code)
        {
            if (this.varType == Type.CONST && this.varType == Type.CONST)
                return new VarValue(ApplyOperation(this.value, right.value, code));
            return OperationUnderNotConst(this, right);
        }
