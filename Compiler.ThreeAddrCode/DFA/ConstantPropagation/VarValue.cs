...
namespace Compiler.ThreeAddrCode.DFA.ConstantPropagation
{
	public class VarValue
	{
		...
		public static VarValue UseOperation(VarValue left, VarValue right, OpCode op)
		{
			if (left.varType == Type.CONST && left.varType == Type.CONST)
				return new VarValue(ApplyOperation(left.value, right.value, op));
